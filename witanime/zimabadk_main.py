...
from witanime.video_providers.uploadourvideo import upload_dowload_handler


from witanime.anime_site.zimabadk_extractor import (
    get_episodes_list,
    get_search_results_link,
    get_links_from_episode,
)
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Download anime from zimabadk")
    ...
    for i, episode_link in enumerate(episodes_link):
        ...
        try:
            ...
            print("Downloading from uploadourvideo.com")
