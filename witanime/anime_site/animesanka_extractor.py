...
def get_all_episodes_server_link(anime_link):
    url = anime_link
    payload = {}
    headers = {
        "authority": "www.anime-sanka.com",
...
#     "user-agent": "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Safari/537.36",
# }
# anime_link = "https://ar.anime-sanka.com/https://watch.animesanka.com/2020/03/ao-no-exorcist-season-1.html"
# response = requests.request("GET", anime_link, headers=headers)
# response = response.text

# print(response)
# # %%
# link = "https://watch.animesanka.com/2020/03/ao-no-exorcist-season-1.html"
# search_link = link.replace("watch.animesanka.com", "prwd.animesanka.club")
# # ["']id["']: *["'](.*)["'],[\s\n]*["']link["']: *["']https://prwd.animesanka.club/2020/03/ao-no-exorcist-season-1.html["']
